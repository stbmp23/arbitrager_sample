...
describe Arbitrager::Api::Quoinex do
  let(:client) { Arbitrager::Api::Quoinex.new }
  let(:endpoint_url) { Arbitrager::Api::Quoinex::ENDPOINT_URL }
  let(:product_id) { Arbitrager::Api::Quoinex::PRODUCT_ID }
  let(:json) { fixture_api('quoinex/' + json_file).read }

  # 板情報を取得する
  describe "#order_books" do
    let(:stub_order_books) { stub_request(:get, endpoint_url + "/products/#{product_id}/price_levels") }
  ...
  describe "#send_order" do
    ...
    let(:stub_send_order) { stub_request(:post, endpoint_url + "/orders/") }
  ...
  describe "#get_orders" do
    ...
    let(:stub_get_orders) {
      stub_request(:get, endpoint_url + "/orders?product_id=#{product_id}")
    }
  ...
  describe "#get_order" do
    ...
    let(:stub_get_order) {
      stub_request(:get, endpoint_url + "/orders/#{order_id}")
    }
  ...
  describe "#get_active_orders" do
    ...
    let(:stub_get_active_orders) {
      stub_request(:get, endpoint_url + "/orders?product_id=#{product_id}&status=live")
    }
  ...
  describe "#get_balance" do
    ...
    let(:stub_get_balance) { stub_request(:get, endpoint_url + "/accounts/balance") }
