...
describe Arbitrager::Balances::Quoinex do
  let(:balance) { Arbitrager::Balances::Quoinex.new }
  let(:endpoint_url) { Arbitrager::Api::Quoinex::ENDPOINT_URL }
  let(:json) { fixture('balancer/quoinex/' + json_file) }
  let(:stub_get_balance) {
    stub_request(:get, endpoint_url + "/accounts/balance")
  }
