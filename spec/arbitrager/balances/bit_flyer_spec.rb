...
describe Arbitrager::Balances::BitFlyer do
  let(:balance) { Arbitrager::Balances::BitFlyer.new }
  let(:endpoint_url) { Arbitrager::Api::BitFlyer::ENDPOINT_URL }
  let(:json) { fixture('balancer/bitflyer/' + json_file) }
  let(:stub_get_balance) {
    stub_request(:get, endpoint_url + "/v1/me/getbalance")
  }
